---
title: "Calculating Drug Doses, Bronchodilators & Mucus-Controlling Therapy"
description: "Covers Slides 39–88: Drug dose calculations, bronchodilators (SABAs, LABAs, anticholinergics), peak flow monitoring, xanthines, and mucus-controlling drug therapy."
order: 2
---
...
Diseases commonly associated with above normal mucus production/clearance:
...
**Indications:** breaks disulfide bonds in mucus. Can also be given for Tylenol overdoses.

**Administration:** inhalation via nebulization; instilled directly into target lobes via bronchoscope

**Hazards:**

- Airway irritation/bronchospasm
- Airway obstruction from liquifying mucus
- Nausea due to sulfur smell

---

## Dornase Alfa (Pulmozyme)

Selectively lyses DNA structure of mucus.
...
**Special handling instructions:** Photosensitive; refrigerated 36–46 F°; cannot be mixed with other medications

---

## Hypertonic Saline (Hyper-Sal)

Induces cough/mobilizes secretions (useful in obtaining sputum sample).
